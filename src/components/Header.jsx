...
const Header = ({ theme, toggleTheme }) => (
  <header className="flex container mx-auto p-6 mb-6 max-w-6xl justify-between content-center">
    ...
    <div className="flex content-center space-x-6">
      ...
      <a
        href="#"
        className="flex p-2 bg-black dark:bg-neutral-800 text-white dark:text-black space-x-2 font-regular uppercase hover:drop-shadow-lg hover:text-lime-500 focus:outline-lime-500 px-4 items-center"
      >
